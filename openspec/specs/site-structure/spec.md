...
The site SHALL provide visual indicators of current position.

#### Scenario: Scroll progress
- **GIVEN** a visitor is scrolling through the site
- **WHEN** they are partway through
- **THEN** they have some indication of their position (e.g., dot indicators, progress bar)
