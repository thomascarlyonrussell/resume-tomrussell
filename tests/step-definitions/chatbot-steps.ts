...
Then('the chat widget appears in collapsed state at center-bottom', async function (this: CustomWorld) {
  const chatWidget = this.page!.locator('[data-testid="chat-widget"]');
...
When('the visitor types a message {string} and presses Enter', async function (this: CustomWorld, message: string) {
...
// Starter prompts
When('the visitor clicks a starter prompt button {string}', async function (this: CustomWorld, promptText: string) {
  const promptButton = this.page!.locator('[data-testid="starter-prompt"]', { hasText: promptText });
...
Given('the visitor asks about Tom\'s experience with a specific technology {string}', async function (this: CustomWorld, technology: string) {
  await this.page!.goto(this.baseUrl);
  const chatButton = this.page!.locator('[data-testid="chat-button"]');
  await chatButton.click();
  await this.page!.waitForTimeout(300);
...
Given('the visitor asks about something not in the knowledge base {string}', async function (this: CustomWorld, question: string) {
  await this.page!.goto(this.baseUrl);
  const chatButton = this.page!.locator('[data-testid="chat-button"]');
  await chatButton.click();
  await this.page!.waitForTimeout(300);
...
Then('it provides accurate information about Tom\'s work on LoadSEER', async function (this: CustomWorld) {
  const aiMessage = this.page!.locator('[data-testid="chat-message"][data-role="assistant"]').last();
  await expect(aiMessage).toBeVisible({ timeout: 10000 });
  const messageText = await aiMessage.textContent();
...
// Boundary steps
Given('the visitor asks about Tom\'s personal life {string}', async function (this: CustomWorld, question: string) {
  await this.page!.goto(this.baseUrl);
  const chatButton = this.page!.locator('[data-testid="chat-button"]');
  await chatButton.click();
  await this.page!.waitForTimeout(300);
...
Given('the visitor asks about salary expectations {string}', async function (this: CustomWorld, question: string) {
  await this.page!.goto(this.baseUrl);
  const chatButton = this.page!.locator('[data-testid="chat-button"]');
  await chatButton.click();
  await this.page!.waitForTimeout(300);
...
Given('a recruiter asks about availability {string}', async function (this: CustomWorld, question: string) {
  await this.page!.goto(this.baseUrl);
  const chatButton = this.page!.locator('[data-testid="chat-button"]');
  await chatButton.click();
  await this.page!.waitForTimeout(300);
...
Given('a question requiring a detailed answer {string}', async function (this: CustomWorld, question: string) {
  await this.page!.goto(this.baseUrl);
  const chatButton = this.page!.locator('[data-testid="chat-button"]');
  await chatButton.click();
  await this.page!.waitForTimeout(300);
...
Then('the user sees content before the full response completes', async function (this: CustomWorld) {
