      ...
      {milestone && (
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-xl bg-white dark:bg-gray-800 shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="sticky top-0 z-10 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-[var(--color-engineering)] to-[var(--color-software-development)] p-6">
            ...
            <div className="p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {relatedSkills.map((skill) => {
                      ...
                      return (
                        <div
                          key={skill.id}
                          className="rounded-lg border border-gray-200 dark:border-gray-700 p-3 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
                        >
              ...
              {/* Impact Section */}
              <div className="rounded-lg bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 border border-gray-200 dark:border-gray-700">
            ...
            {/* Footer */}
            <div className="sticky bottom-0 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 p-4">
              <button
                onClick={onClose}
                className="w-full rounded-lg bg-gradient-to-r from-[var(--color-engineering)] to-[var(--color-software-development)] px-4 py-2 text-sm font-medium text-white hover:opacity-90 transition-opacity"
              >
                Close
              </button>
            </div>
