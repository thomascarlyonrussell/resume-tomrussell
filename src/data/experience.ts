...
export const experience: Experience[] = [
  {
    ...
    skills: [
      ...
      { skillId: 'spatial-forecasting', rigor: 5 },
      { skillId: 'claude-ai', rigor: 5 },
      { skillId: 'github-copilot', rigor: 5 },
      { skillId: 'ai-agent-development', rigor: 5 },
      { skillId: 'python', rigor: 5 },
      { skillId: 'github', rigor: 5 },
      { skillId: 'openai-codex', rigor: 4 },
      { skillId: 'azure-devops', rigor: 4 },
      { skillId: 'technical-training', rigor: 4 },
      { skillId: 'productboard', rigor: 3 },
      { skillId: 'jira', rigor: 3 },
      { skillId: 'playwright', rigor: 3 },
      { skillId: 'openspec', rigor: 3 },
    ] as ExperienceSkill[],
  },
  {
    ...
    skills: [
      ...
      { skillId: 'stakeholder-management', rigor: 8 },
      { skillId: 'cross-functional-collaboration', rigor: 8 },
      { skillId: 'team-management', rigor: 5 },
      { skillId: 'python', rigor: 5 },
      ...
      { skillId: 'spatial-forecasting', rigor: 3 },
    ] as ExperienceSkill[],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { skillId: 'spatial-forecasting', rigor: 2 },
